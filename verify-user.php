			...
			<div class="col-12">
				<hgroup class="hgroup">
					...
					<div class="step-start">
						<p class="text-muted">สำหรับผู้ที่มีบัญชีผู้ใช้ THAITICKETMAJOR แล้ว</p>
					</div>
					<div class="step-verify" style="display: none;">
						...
						<p class="text-muted">รหัสมีอายุการใช้งาน 5 นาที</p>
					</div>
				</hgroup>
			</div>
			<div class="col-12 col-md-6 col-xl-4">
				<form class="mt-3" id="form-verify" novalidate autocomplete="off">
					<div class="step-start">
						...
						<p>
							กรุณายืนยันว่าอีเมลล์ที่กรอกมาถูกต้องเพื่อรับ OTP
						</p>
						<p class="text-red">
							หากลูกค้าไม่ยืนยันบัญชีผู้ใช้ ลูกค้าจะยังสามารถดูประวัติการสั่งซื้อ แต่จะไม่สามารถซื้อบัตรใหม่ได้จนกว่าจะยืนยันผ่าน OTP
						</p>
						<div class="form-group">
							<div class="custom-control custom-checkbox">
								<input type="checkbox" class="custom-control-input" id="terms" name="terms-service">
								<label class="custom-control-label font-reg" for="terms">ข้าพเจ้ายอมรับ <a href="https://corporate.thaiticketmajor.com/policies.php"  target="_blank"><u>ข้อกำหนดและเงื่อนไขในการเข้างาน</u></a> เว็บไซต์ไทยทิคเกตเมเจอร์</label>
								<div class="text-alert px-0"></div>
							</div>
						</div>
						<p>
							<button type="button" class="btn btn-block btn-lg btn-primary" onclick="$app.verifyEmail.submitEmail();">กดเพื่อส่ง OTP</button>
						</p>
					</div>
					<div class="step-verify" style="display: none;">
						<div class="row">
